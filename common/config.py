...
config.H36M_DATA.BONES = [[0, 1], [1, 2], [2, 3], [0, 4], [4, 5], [5, 6], [0, 7], [7, 8], [8, 9], [9, 10], [8, 11],
...
config.TOTALCAP_DATA.BONES = [[0, 0], [0, 1], [1, 2], [2, 3], [0, 4], [4, 5], [5, 6], [0, 7], [7, 8], [8, 9], [8, 10],
                              [10, 11], [11, 12], [8, 13], [13, 14], [14, 15]]
...
config.TEST.METRIC = "p_mpjpe"  # ['mpjpe', 'p_mpjpe', 'n_mpjpe']
...
def reset_config(cfg, args):
    ...
    if args.eval_view_list is not None:
        cfg.H36M_DATA.TEST_CAMERAS = [args.eval_view_list] if isinstance(args.eval_view_list,
                                                                         int) else args.eval_view_list
    if args.eval:
