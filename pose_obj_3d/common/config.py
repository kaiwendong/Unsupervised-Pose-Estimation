...
config.OBJ_POSE_DATA.NUM_JOINTS = 12
...
if config.DATA.DATASET_NAME =='obj_pose':
    config.NETWORK.INPUT_DIM = 2 # obj_class, xmin, xmax, ymin, ymax
    config.NETWORK.DIM_JOINT = 3 #xmin, xmax, ymin, ymax, zmin, zmax of object shifted to 0rigin + x, y, z of object center (!= data dim joint)
else:
