...
if __name__ == "__main__":
    ...
    parser.add_argument('--action_on_data', type=str, help='choose among {"get_data_stats", "convert_data", "get_cameras_matrixes", "visualize_segmentation_colors"}' , required=False)
